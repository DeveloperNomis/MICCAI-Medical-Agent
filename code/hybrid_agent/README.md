...
export YOLO_WEIGHTS_PATH=$PROJECT_ROOT/checkpoints/yolo_detector_best.pt
...
To use a different compatible detector checkpoint, set `YOLO_WEIGHTS_PATH` to that local checkpoint instead.
